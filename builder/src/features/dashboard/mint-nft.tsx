      ...
      {currentAccount && (
        <Menu as="div" className="relative">
          <Menu.Button
            ...
            className={`${newPublishStatus ? 'cursor-pointer' : 'cursor-not-allowed'} py-3 px-5 my-2 ml-3 text-[14px] font[500] button-singleTemp`}
          >
          ...
          {!newPublishStatus ? (
            <Menu.Items className="py-6 px-4 absolute right-0 top-[4rem] bg-white w-[214px] shadow-menu rounded-[16px]">
              <Menu.Item as="div" className="text-[13px] cursor-pointer text-[#6E7191] hover:text-[#14142B]">
                <div className="mb-2 text-[#14142B] opacity-50 mx-1 ">Please publish the site before minting this template.</div>
                <button
                  className={`${
