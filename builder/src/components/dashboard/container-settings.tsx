...
const ContainerSettings: FC = () => {
  ...
  return (
    <>
      ...
      <BgColorComponent name={selectedElement.name} i={selectedElement.i} elementBackgroundColor={selectedElement.style.backgroundColor} />
      ...
      <BorderRadiusComponent i={selectedElement.i} borderRadius={selectedElement.style.borderRadius} borderColor={selectedElement.style.color} />
