      ...
      <div className="flex flex-col justify-center items-center pt-3">
        ...
        <div className="flex gap-4 bg-gray-100 mt-8 rounded-[4px] py-3.5 px-4">
          ...
          <div className="text-[14px] text-[#1C1C1E] opacity-60">
            ...
            market place, we’ll notify you once it is ready to go on the market
            place.
          </div>
        </div>
        <div
          onClick={handleClose}
          className="cursor-pointer text-[13px] text-white font-[500] bg-[#8268E5] rounded-[4px] py-3 px-10 my-7"
        >
          Okay
        </div>
      </div>
