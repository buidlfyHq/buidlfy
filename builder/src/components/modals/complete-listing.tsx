...
const CompleteListing: FC = () => {
  ...
  const [approvalText, setApprovalText] = useState<string>('Approve Collection')
      ...
      <div className="flex flex-col items-center w-full px-10">
        ...
        <div className="w-full border-top-divider-publish">
          ...
          {!confirm ? (
            ...
            <div className="flex gap-5 py-5">
              <div><img src={Approve1} alt="icon" width={24} height={24} /></div>
              <div className="flex flex-col items-start">
                <div className="text-[#202525] font-[500] text-[14px]">Confirm Listing</div>
                <div className="text-[#14142B] opacity-50 text-[13px] mt-2.5">YOu need to confirm that you want to list this template on buidlfy.</div>
                { confirmWait ? (
