...
const CompleteListing: FC = () => {
  ...
  return (
    <Dialog.Panel className="flex flex-col justify-center items-center w-full max-w-[527px] min-w-[330px] my-20 sm:mx-28 mx-12 rounded-[15px] bg-white">
      <button className="flex items-start justify-end w-full px-6 py-5" onClick={() => dispatch(toggleModal(false))}>
        ...
        <section className="flex w-full justify-between items-center text-[#14142B]  text-[14px] my-5">
          <div className="flex items-center gap-6">
            <div className="h-[54px] w-[54px] flex items-center">
              <img src={selectedTemplate.image} className="w-full h-full rounded-[4px]" alt="icon" />
            </div>
            <div className="flex flex-col items-start">
              <div className="text-[#14142B] opacity-50 font-[500] tex-[12px] ">{selectedTemplate.category}</div>
              <div className="text-[#14142B] font-[600] text-[14px] whitespace-nowrap">{selectedTemplate.name}</div>
          ...
          <div className="flex flex-col items-end">
            ...
            <div className="text-[#14142B] font-[700] text-[14px]">{selectedTemplate.listAmount} USDT</div>
          </div>
        </section>
