  ...
  handleStartFromScratch,
    ...
    return (
        <Dialog className="relative z-50" open={isOpen} onClose={() => setIsOpen(false)}>
            <div className="fixed inset-0 flex items-center justify-center p-4 bg-black/70 backdrop-blur-[10px]">
            <Dialog.Panel className="rounded-[24px] py-16 px-20 bg-white rounded flex flex-row justify-start items-center gap-16">
                ...
                <div onClick={handleStartFromScratch} className="mt-10 rounded-[28px] bg-[#5D46E4] px-9 py-4 text-white text-[16px] text-center text-[600] cursor-pointer">
                    Create from Scratch
                </div>
                </div>
                ...
                <div onClick={handleStartFromTemplate} className="mt-10 rounded-[28px] bg-[#5D46E4] px-9 py-4 text-white text-[16px] text-center text-[600] cursor-pointer">
