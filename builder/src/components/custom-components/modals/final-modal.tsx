    ...
    return (
        <Dialog className="relative z-50" open={isOpenFinalTemplate} onClose={() => setIsOpenFinalTemplate(false)}>
            ...
            <ConfettiShower />
                ...
                Templated has been purchased and it is ready to use.
Please click on the button given below to start using the template
                </div>
                <div onClick={() => setIsOpenFinalTemplate(false)} className="flex items-center text-white px-12 py-5 text-[20px] font-[600] connect-wallet-button rounded-[60px] mt-10 cursor-pointer">
                    Start Creating Now
