    ...
    <div className=''>
        ...
        <div className='flex justify-between px-36 py-6 h-[77px] border-bottom-divider sticky-top'>
            ...
            <div className='flex items-center'>
                ...
                <div className="my-3 ml-5 bg-[#9CB0D7] w-[44px] h-[44px] rounded-[50%] mt-30">{" "}</div>
            </div>
        </div>

        {/* mid sec */}
        <div className='flex flex-col items-center py-16 px-36'>
            <div className='font-[600] text-[28px] text-[#14142B]'>My Templates</div>
            <div className='max-w-[412px] text-[13px] text-[#14142A] opacity-60 text-center mt-4 '>
                Create a beautiful website that meets your needs by choosing from over 100 beautiful templates.
            </div>
        </div>
                                                ...
                                                <Menu>
                                                    ...
                                                    <Menu.Items className="absolute right-0 bg-white shadow-template-box flex flex-col rounded-[4px] bg-white px-3 py-2 top-8 z-[10]">
                                                        ...
                                                        <Menu.Item>
                                                            {({ active }) => (
                                                            <a
                                                                className={`whitespace-nowrap text-[13px] text-[#14142B] px-2 py-1 ${active && 'bg-gray-200 rounded-[4px]'}`}
                                                            >
                                                                View site
                                                            </a>
                                                            )}
