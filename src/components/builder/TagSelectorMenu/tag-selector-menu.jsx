...
const TagSelectorMenu = ({ position, closeMenu, handleSelection }) => {
  ...
  return (
    <div
      className="absolute w-96 h-full z-10 flex flex-col"
      style={{
        top: y,
        left: x,
            ...
            <div
              ...
              className={
                tagList.indexOf(tag) === selectedTag
                  ? [
                      "text-lg font-bold py-8 px-16 border-b border-white/80 hover:bg-white/70 hover:cursor-pointer focus:bg-white/70 focus:cursor-pointer",
                      "bg-white/70 rounded",
                    ].join(" ")
                  : "text-lg font-bold py-8 px-16 border-b border-white/80 hover:bg-white/70 hover:cursor-pointer focus:bg-white/70 focus:cursor-pointer"
              }
