            ...
            >
              {this.state.tag !== "img" && (
                <ContentEditable
                  ...
                  className={[
                    "inline-block w-fit m-4 p-4 hover:bg-white/90 focus:bg-white/80 outline outline-transparent hover:outline-white/80 focus:outline-white/80 select-text shadow",
                    this.state.isTyping ||
                    this.state.actionMenuOpen ||
                    this.state.tagSelectorMenuOpen
                      ? "bg-white/80 outline outline-white/80"
                      : null,
                    this.state.placeholder ? "text-zinc-600" : null,
                    snapshot.isDragging
                      ? "bg-white/80 outline outline-white/80"
                      : null,
                  ].join(" ")}
              ...
              {this.state.tag === "img" && (
                <div
                  ...
                  className={[
                    "inline-block w-[calc(100%-1rem)] p-4",
                ...
                >
                  ...
                  {!this.state.imageUrl && (
                    <label
                      ...
                      className="block py-8 px-4 text-zinc-400 text-lg tracking-wide"
                    >
                  ...
                  {this.state.imageUrl && (
                    <img
                      ...
                      className="block max-h-screen max-w-full my-0 mx-auto"
                    />
                  )}
                </div>
              )}
              <span
                role="button"
                tabIndex="0"
                className="opacity-100 inline-block w-12"
